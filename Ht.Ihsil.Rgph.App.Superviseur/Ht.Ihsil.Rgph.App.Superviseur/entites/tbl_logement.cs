...
namespace Ht.Ihsil.Rgph.App.Superviseur.entites
{
    ...
    public partial class tbl_logement
    {
        ...
        public Nullable<long> qlin6ServiceElectricite { get; set; }
        public Nullable<long> qlin7ServiceEau { get; set; }
        public Nullable<long> qlin8QualiteToillettes { get; set; }
        public Nullable<long> Qlin6NombrePiece { get; set; }
        public Nullable<long> Qlin7NbreChambreACoucher { get; set; }
        public Nullable<long> qlin11NbreIndividuVivant { get; set; }
