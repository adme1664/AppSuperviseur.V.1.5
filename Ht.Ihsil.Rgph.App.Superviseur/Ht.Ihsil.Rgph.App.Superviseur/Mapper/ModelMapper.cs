        ...
        public static BatimentModel MapToBatiment(tbl_batiment batiment)
        {
            if (batiment != null)
            {
                return new BatimentModel
                {
                    ...
                    Zone = Convert.ToInt32(batiment.zone),
                    ...
                    Qb1Etat = Convert.ToInt32(batiment.qb1Etat),
                    Qb2Type = Convert.ToInt32(batiment.qb2Type),
                    Qb3NombreEtage = Convert.ToInt32(batiment.qb3NombreEtage),
                    Qb5MateriauToit = Convert.ToInt32(batiment.qb5MateriauToit),
                    Qb4MateriauMur = Convert.ToInt32(batiment.qb4MateriauMur),
                    Qb6StatutOccupation = Convert.ToInt32(batiment.qb6StatutOccupation),
                    Qb7Utilisation1 = Convert.ToInt32(batiment.qb7Utilisation1),
                    Qb7Utilisation2 = Convert.ToInt32(batiment.qb7Utilisation2),
                    Qb8NbreLogeCollectif = Convert.ToInt32(batiment.qb8NbreLogeCollectif),
                    Qb8NbreLogeIndividuel = Convert.ToInt32(batiment.qb8NbreLogeIndividuel),
                    Statut = Convert.ToInt32(batiment.statut),
        ...
        public static LogementModel MapToLogement(tbl_logement logement)
        {
            if (logement != null)
            {
                return new LogementModel
                {
                    ...
                    QlCategLogement = Convert.ToInt32(logement.qlCategLogement),
                    Qlin1NumeroOrdre = Convert.ToInt32(logement.qlin1NumeroOrdre),
                    Qlc1TypeLogement = Convert.ToInt32(logement.qlc1TypeLogement),
                    Qllc2bTotalGarcon = Convert.ToInt32(logement.qllc2bTotalGarcon),
                    Qlc2bTotalFille = Convert.ToInt32(logement.qlc2bTotalFille),
                    QlcTotalIndividus = Convert.ToInt32(logement.qlcTotalIndividus),
                    Qlin2StatutOccupation = Convert.ToInt32(logement.qlin2StatutOccupation),
                    Qlin3ExistenceLogement = Convert.ToInt32(logement.qlin3ExistenceLogement),
                    Qlin4TypeLogement = Convert.ToInt32(logement.qlin4TypeLogement),
                    Qlin5MateriauSol = Convert.ToInt32(logement.qlin5MateriauSol),
                    Qlin6NombrePiece = Convert.ToInt32(logement.qlin6NombrePiece),
                    Qlin7NbreChambreACoucher = Convert.ToInt32(logement.qlin7NbreChambreACoucher),
                    Qlin8NbreIndividuDepense = Convert.ToInt32(logement.qlin8NbreIndividuDepense),
                    Qlin9NbreTotalMenage = Convert.ToInt32(logement.qlin9NbreTotalMenage),
                    Statut = Convert.ToInt32(logement.statut),
                    ...
                    NbrTentative = Convert.ToInt32(logement.nbrTentative),
        ...
        public static MenageModel MapToMenage(tbl_menage menage)
        {
            if (menage != null)
            {
                return new MenageModel
                {
                    ...
                    SdeId = menage.sdeId,
                    Qm1NoOrdre = Convert.ToInt32(menage.qm1NoOrdre),
                    Qm2ModeJouissance = Convert.ToInt32(menage.qm2ModeJouissance),
                    Qm3ModeObtentionLoge = Convert.ToInt32(menage.qm3ModeObtentionLoge),
                    Qm4_1ModeAprovEauABoire = Convert.ToInt32(menage.qm4_1ModeAprovEauABoire),
                    Qm4_2ModeAprovEauAUsageCourant = Convert.ToInt32(menage.qm4_2ModeAprovEauAUsageCourant),
                    Qm5SrcEnergieCuisson1 = Convert.ToInt32(menage.qm5SrcEnergieCuisson1),
                    Qm5SrcEnergieCuisson2 = Convert.ToInt32(menage.qm5SrcEnergieCuisson2),
                    Qm6TypeEclairage = Convert.ToInt32(menage.qm6TypeEclairage),
                    Qm7ModeEvacDechet = Convert.ToInt32(menage.qm7ModeEvacDechet),
                    Qm8EndroitBesoinPhysiologique = Convert.ToInt32(menage.qm8EndroitBesoinPhysiologique),
                    ...
                    Qm10AvoirPersDomestique = Convert.ToInt32(menage.qm10AvoirPersDomestique),
                    Qm10TotalDomestiqueFille = Convert.ToInt32(menage.qm10TotalDomestiqueFille),
                    Qm10TotalDomestiqueGarcon = Convert.ToInt32(menage.qm10TotalDomestiqueGarcon),
                    Qm11TotalIndividuVivant = Convert.ToInt32(menage.qm11TotalIndividuVivant),
                    Qn1Emigration = Convert.ToInt32(menage.qn1Emigration),
                    Qn1NbreEmigreFille = Convert.ToInt32(menage.qn1NbreEmigreFille),
                    Qn1NbreEmigreGarcon = Convert.ToInt32(menage.qn1NbreEmigreGarcon),
                    Qd1Deces = Convert.ToInt32(menage.qd1Deces),
                    Qd1NbreDecedeFille = Convert.ToInt32(menage.qd1NbreDecedeFille),
                    Qd1NbreDecedeGarcon = Convert.ToInt32(menage.qd1NbreDecedeGarcon),
                    Statut = Convert.ToInt32(menage.statut),
        ...
        public static DecesModel MapToDeces(tbl_deces deces)
        {
            if (deces != null)
            {
                return new DecesModel
                {
                    ...
                    SdeId = deces.sdeId,
                    Qd2NoOrdre = Convert.ToInt32(deces.qd2NoOrdre),
                    Qd2aSexe = Convert.ToInt32(deces.qd2aSexe),
                    Qd2bAgeDecede = Convert.ToInt32(deces.qd2bAgeDecede),
                    Qd2c1CirconstanceDeces = Convert.ToInt32(deces.qd2c1CirconstanceDeces),
                    Qd2c2CauseDeces = Convert.ToInt32(deces.qd2c2CauseDeces),
                    Statut = Convert.ToInt32(deces.statut),
        ...
        public static EmigreModel MapToEmigre(tbl_emigre emigre)
        {
            if (emigre != null)
            {
                return new EmigreModel
                {
                    ...
                    SdeId = emigre.sdeId,
                    Qn1numeroOrdre = Convert.ToInt32(emigre.qn1numeroOrdre),
                    Qn2aNomComplet = emigre.qn2aNomComplet,
                    Qn2bResidenceActuelle = Convert.ToInt32(emigre.qn2bResidenceActuelle),
                    Qn2cSexe = Convert.ToInt32(emigre.qn2cSexe),
                    Qn2dAgeAuMomentDepart = Convert.ToInt32(emigre.qn2dAgeAuMomentDepart),
                    Qn2eDernierPaysResidence = Convert.ToInt32(emigre.qn2eDernierPaysResidence),
                    Statut = Convert.ToInt32(emigre.statut),
        ...
        public static IndividuModel MapToIndividu(tbl_individu individu)
        {
            if (individu != null)
            {
                return new IndividuModel
                {
                    ...
                    Q1NoOrdre = Convert.ToInt32(individu.q1NoOrdre),
                    Q3Prenom = individu.q3Prenom,
                    Q2Nom = individu.q2Nom,
                    Qp3LienDeParente = Convert.ToInt32(individu.qp3LienDeParente.GetValueOrDefault()),
                    Q3HabiteDansMenage = Convert.ToInt32(individu.q3HabiteDansMenage),
                    Q4Sexe = Convert.ToInt32(individu.q4Sexe),
                    Q7DateNaissanceJour = Convert.ToInt32(individu.q5DateNaissanceJour),
                    Q7DateNaissanceMois = Convert.ToInt32(individu.q5DateNaissanceMois),
                    Q7DateNaissanceAnnee = Convert.ToInt32(individu.q5DateNaissanceAnnee),
                    Q5bAge = Convert.ToInt32(individu.q5bAge),
                    Qp6religion = Convert.ToInt32(individu.qp6religion),
                    Qp6AutreReligion = individu.qp6AutreReligion,
                    Qp7Nationalite = Convert.ToInt32(individu.qp7Nationalite),
                    Qp7PaysNationalite = individu.qp7PaysNationalite,
                    Qp8MereEncoreVivante = Convert.ToInt32(individu.qp8MereEncoreVivante),
                    Qp9EstPlusAge = Convert.ToInt32(individu.qp9EstPlusAge),
                    Qp10LieuNaissance = Convert.ToInt32(individu.qp10LieuNaissance),
                    ...
                    Qp11PeriodeResidence = Convert.ToInt32(individu.qp11PeriodeResidence),
                    Qp12DomicileAvantRecensement = Convert.ToInt32(individu.qp12DomicileAvantRecensement),
                    ...
                    Qe1EstAlphabetise = Convert.ToInt32(individu.qe1EstAlphabetise),
                    Qe2FreqentationScolaireOuUniv = Convert.ToInt32(individu.qe2FreqentationScolaireOuUniv),
                    Qe3typeEcoleOuUniv = Convert.ToInt32(individu.qe3typeEcoleOuUniv),
                    Qe4aNiveauEtude = Convert.ToInt32(individu.qe4aNiveauEtude),
                    Qe4bDerniereClasseOUAneEtude = individu.qe4bDerniereClasseOUAneEtude.GetValueOrDefault().ToString(),
                    Qe5DiplomeUniversitaire = Convert.ToInt32(individu.qe5DiplomeUniversitaire),
                    Qe6DomaineEtudeUniversitaire = individu.qe6DomaineEtudeUniversitaire,
                    Qaf1HandicapVoir = Convert.ToInt32(individu.qaf1HandicapVoir),
                    Qaf2HandicapEntendre = Convert.ToInt32(individu.qaf2HandicapEntendre),
                    Qaf3HandicapMarcher = Convert.ToInt32(individu.qaf3HandicapMarcher),
                    Qaf4HandicapSouvenir = Convert.ToInt32(individu.qaf4HandicapSouvenir),
                    Qaf5HandicapPourSeSoigner = Convert.ToInt32(individu.qaf5HandicapPourSeSoigner),
                    Qaf6HandicapCommuniquer = Convert.ToInt32(individu.qaf6HandicapCommuniquer),
                    Qt1PossessionTelCellulaire = Convert.ToInt32(individu.qt1PossessionTelCellulaire),
                    Qt2UtilisationInternet = Convert.ToInt32(individu.qt2UtilisationInternet),
                    Qem1DejaVivreAutrePays = Convert.ToInt32(individu.qem1DejaVivreAutrePays),
                    Qem1AutrePays = individu.qem1AutrePays,
                    Qem2MoisRetour = Convert.ToInt32(individu.qem2MoisRetour),
                    Qem2AnneeRetour = Convert.ToInt32(individu.qem2AnneeRetour),
                    Qsm1StatutMatrimonial = Convert.ToInt32(individu.qsm1StatutMatrimonial),
                    Qa1ActEconomiqueDerniereSemaine = Convert.ToInt32(individu.qa1ActEconomiqueDerniereSemaine),
                    Qa2ActAvoirDemele1 = Convert.ToInt32(individu.qa2ActAvoirDemele1),
                    Qa2ActDomestique2 = Convert.ToInt32(individu.qa2ActDomestique2),
                    Qa2ActCultivateur3 = Convert.ToInt32(individu.qa2ActCultivateur3),
                    Qa2ActAiderParent4 = Convert.ToInt32(individu.qa2ActAiderParent4),
                    Qa2ActAutre5 = Convert.ToInt32(individu.qa2ActAutre5),
                    Qa3StatutEmploie = Convert.ToInt32(individu.qa3StatutEmploie),
                    Qa4SecteurInstitutionnel = Convert.ToInt32(individu.qa4SecteurInstitutionnel),
                    Qa5TypeBienProduitParEntreprise = individu.qa5TypeBienProduitParEntreprise,
                    Qa6LieuActDerniereSemaine = Convert.ToInt32(individu.qa6LieuActDerniereSemaine),
                    Qa7FoncTravail = Convert.ToInt32(individu.qa7FoncTravail),
                    Qa8EntreprendreDemarcheTravail = Convert.ToInt32(individu.qa8EntreprendreDemarcheTravail),
                    Qa9VouloirTravailler = Convert.ToInt32(individu.qa9VouloirTravailler),
                    Qa10DisponibilitePourTravail = Convert.ToInt32(individu.qa10DisponibilitePourTravail),
                    Qa11RecevoirTransfertArgent = Convert.ToInt32(individu.qa11RecevoirTransfertArgent),
                    ...
                    Qf3DernierEnfantJour = Convert.ToInt32(individu.qf3DernierEnfantJour),
                    Qf3DernierEnfantMois = Convert.ToInt32(individu.qf3DernierEnfantMois),
                    Qf3DernierEnfantAnnee = Convert.ToInt32(individu.qf3DernierEnfantAnnee),
                    Qf4DENeVivantVit = Convert.ToInt32(individu.qf4DENeVivantVit),
                    Statut = Convert.ToInt32(individu.statut),
