    ...
    public class WsModelMapper
    {
        ...
        public static LogementCType MapReaderToLogementCollectifType(tbl_logement logement)
        {
            return new LogementCType
            {
                ...
                qllc2bTotalGarcon = Convert.ToByte(logement.qllc2bTotalGarcon),
        ...
        public static EmigreType MapReaderToEmigreType(tbl_emigre emigre)
        {
            return new EmigreType
            {
                ...
                qn2cSexe = Convert.ToByte(emigre.qn2cSexe),
        ...
        public static IndividuType MapReaderToIndividuType(tbl_individu individu)
        {
            if (individu != null)
            {
                return new IndividuType
                {
                    ...
                    q5HabiteDansMenage = Convert.ToByte(individu.q3HabiteDansMenage),
                    q4Sexe = Convert.ToByte(individu.q4Sexe),
                    q7DateNaissanceJour = Convert.ToByte(individu.q5DateNaissanceJour),
                    q7DateNaissanceMois = Convert.ToByte(individu.q5DateNaissanceMois),
                    q7DateNaissanceAnnee = Convert.ToInt32(individu.q5DateNaissanceAnnee),
                    q5bAge = Convert.ToByte(individu.q5bAge),
