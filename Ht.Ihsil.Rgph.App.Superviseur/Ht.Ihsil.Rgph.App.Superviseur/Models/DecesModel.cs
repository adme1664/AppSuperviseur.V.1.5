...
namespace Ht.Ihsil.Rgph.App.Superviseur.Models
{
    public class DecesModel
    {
        ...
        public int Qd2NoOrdre { get; set; }
        public int Qd2aSexe { get; set; }
        public int Qd2bAgeDecede { get; set; }
        public int Qd2c1CirconstanceDeces { get; set; }
        public int Qd2c2CauseDeces { get; set; }
